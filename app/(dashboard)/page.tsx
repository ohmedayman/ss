      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        <div className="glass-panel glass-panel-hover rounded-2xl p-5 relative overflow-hidden">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-slate-500">إجمالي الشاشات</span>
          ...
          <div className="mt-3 pt-3 border-t border-slate-100 flex items-center justify-between text-[11px] text-slate-400">
            ...
            <Link href="/screens" className="text-indigo-600 hover:underline flex items-center gap-0.5">
        ...
        <div className="glass-panel glass-panel-hover rounded-2xl p-5 relative overflow-hidden">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-slate-500">الشاشات المتصلة (Online)</span>
          ...
          <div className="mt-3 flex items-baseline gap-2">
            ...
            <span className="text-xs text-emerald-600/80 font-medium">تعمل الآن مباشرة</span>
          </div>
          <div className="mt-3 pt-3 border-t border-slate-100 flex items-center justify-between text-[11px] text-slate-400">
            <span>تحديثات مستمرة كل 15 ثانية</span>
            <span className="text-emerald-600 font-semibold">100% نشط</span>
          </div>
        </div>
        ...
        <div className="glass-panel glass-panel-hover rounded-2xl p-5 relative overflow-hidden">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-slate-500">الشاشات غير المتصلة</span>
          ...
          <div className="mt-3 flex items-baseline gap-2">
            ...
            <span className="text-xs text-amber-600/90 font-medium">غير متصلة أو جاهزة للربط</span>
          </div>
          <div className="mt-3 pt-3 border-t border-slate-100 flex items-center justify-between text-[11px] text-slate-400">
        ...
        <div className="glass-panel glass-panel-hover rounded-2xl p-5 relative overflow-hidden">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-slate-500">المحتوى والوسائط</span>
          ...
          <div className="mt-3 pt-3 border-t border-slate-100 flex items-center justify-between text-[11px] text-slate-400">
            ...
            <Link href="/media" className="text-indigo-600 hover:underline flex items-center gap-0.5">
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-base font-bold text-slate-900">مراقبة الشاشات الحية (Live Screens Matrix)</h3>
          </div>
          <div className="flex items-center gap-2">
            <button
              onClick={loadData}
                ...
                <div className="p-4 flex-1 flex flex-col justify-between space-y-3">
                  ...
                  <div className="pt-3 border-t border-slate-100 flex items-center justify-between gap-1.5">
                    <button
                      ...
                      className="flex-1 py-1.5 px-2 rounded-xl bg-white hover:bg-slate-50 text-slate-600 text-[11px] font-medium flex items-center justify-center gap-1.5 border border-slate-200 transition-colors cursor-pointer disabled:opacity-50"
                    >
                      <RotateCw className={`w-3 h-3 text-indigo-500 ${actionLoadingId === `${screen.id}-reload` ? 'animate-spin' : ''}`} />
                      <span>تحديث</span>
                    </button>
                    ...
                    <Link
                      ...
                      className="py-1.5 px-3 rounded-xl bg-indigo-50 hover:bg-indigo-100 text-indigo-600 text-[11px] font-semibold flex items-center justify-center gap-1 border border-indigo-100 transition-colors"
                    >
        ...
        <div className="lg:col-span-2 glass-panel rounded-2xl p-6">
          <div className="flex items-center justify-between mb-5">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-bold text-slate-900 text-base">آخر الأنشطة والعمليات (Activity Log)</h3>
            </div>
          ...
          <div className="space-y-3.5">
            <div className="flex items-start gap-3 p-3 rounded-xl bg-slate-50 border border-slate-100">
              ...
              <div className="flex-1 text-xs">
                <div className="flex items-center justify-between">
                  <span className="font-semibold text-slate-800">إسناد قائمة تشغيل</span>
            ...
            <div className="flex items-start gap-3 p-3 rounded-xl bg-slate-50 border border-slate-100">
              ...
              <div className="flex-1 text-xs">
                <div className="flex items-center justify-between">
                  <span className="font-semibold text-slate-800">أمر تحديث فوري (Reload)</span>
                  <span className="text-[11px] text-slate-400">منذ 5 ساعات</span>
                </div>
                <p className="text-slate-500 mt-0.5">
            ...
            <div className="flex items-start gap-3 p-3 rounded-xl bg-slate-50 border border-slate-100">
              ...
              <div className="flex-1 text-xs">
                <div className="flex items-center justify-between">
                  <span className="font-semibold text-slate-800">رفع وسائط جديدة</span>
                  <span className="text-[11px] text-slate-400">منذ 12 ساعة</span>
                </div>
                <p className="text-slate-500 mt-0.5">
